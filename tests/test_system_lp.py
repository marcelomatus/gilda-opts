...
def test_system_lp_1():
    ...
    withdrawn_values = lp.get_col_sol(s1_lp.grids_lp[1].block_withdrawn_cols)
...
def test_system_lp_3():
    ...
    assert lp.get_col_at(s1_lp.grids_lp[1].block_withdrawn_cols[0]) == 1 + 3
    assert lp.get_col_at(s1_lp.grids_lp[1].block_withdrawn_cols[1]) == 2 + 3
    assert lp.get_col_at(s1_lp.grids_lp[1].block_withdrawn_cols[2]) == 3
    assert lp.get_col_at(s1_lp.grids_lp[1].block_withdrawn_cols[3]) == 4
...
def test_system_lp_5():
    ...
    assert lp.get_col_at(s1_lp.grids_lp[1].block_withdrawn_cols[0]) == 7
    assert lp.get_col_at(s1_lp.grids_lp[1].block_withdrawn_cols[1]) == 5.2
    assert lp.get_col_at(s1_lp.grids_lp[1].block_withdrawn_cols[2]) == 5.2
    assert lp.get_col_at(s1_lp.grids_lp[1].block_withdrawn_cols[3]) == 7
...
def test_system_lp_6():
    ...
    assert lp.get_col_at(s1_lp.grids_lp[1].block_withdrawn_cols[0]) == 1
    assert lp.get_col_at(s1_lp.grids_lp[1].block_withdrawn_cols[1]) == 0
    assert lp.get_col_at(s1_lp.grids_lp[1].block_withdrawn_cols[2]) == 3
    assert lp.get_col_at(s1_lp.grids_lp[1].block_withdrawn_cols[3]) == 0

    assert lp.get_col_at(s1_lp.local_sources_lp[1].block_generation_cols[0]) == 0
    assert lp.get_col_at(s1_lp.local_sources_lp[1].block_generation_cols[1]) == 20
    assert lp.get_col_at(s1_lp.local_sources_lp[1].block_generation_cols[2]) == 0
    assert lp.get_col_at(s1_lp.local_sources_lp[1].block_generation_cols[3]) == 10
...
def test_system_lp_7():
    ...
    assert lp.get_col_at(s1_lp.grids_lp[1].block_withdrawn_cols[0]) == 2
    assert lp.get_col_at(s1_lp.grids_lp[1].block_withdrawn_cols[1]) == 3
    assert lp.get_col_at(s1_lp.grids_lp[1].block_withdrawn_cols[2]) == 3
    assert lp.get_col_at(s1_lp.grids_lp[1].block_withdrawn_cols[3]) == 5

    assert lp.get_col_at(s1_lp.cesas_lp[1].block_onoff_cols[0]) == 1
    assert lp.get_col_at(s1_lp.cesas_lp[1].block_onoff_cols[1]) == 1
    assert lp.get_col_at(s1_lp.cesas_lp[1].block_onoff_cols[2]) == 0
    assert lp.get_col_at(s1_lp.cesas_lp[1].block_onoff_cols[3]) == 1
...
def test_system_lp_8():
    ...
    assert lp.get_col_at(s1_lp.grids_lp[1].block_withdrawn_cols[1]) == 3
    assert lp.get_col_at(s1_lp.grids_lp[1].block_withdrawn_cols[2]) == 3
    assert lp.get_col_at(s1_lp.grids_lp[1].block_withdrawn_cols[3]) == 4.5

    assert lp.get_col_at(s1_lp.cesas_lp[1].block_onoff_cols[0]) == 1
    assert lp.get_col_at(s1_lp.cesas_lp[1].block_onoff_cols[1]) == 1
    assert lp.get_col_at(s1_lp.cesas_lp[1].block_onoff_cols[2]) == 0
    assert lp.get_col_at(s1_lp.cesas_lp[1].block_onoff_cols[3]) == 0.5
